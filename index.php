	...
	<div class="container-fluid" style="padding-top: 20px;">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary">
				<div class="panel-heading"><h2>Naz search box</h2></div>
				<div class="panel-body">
					...
					<div class="alert alert-warning" style="display: none;"role="alert"><span class="glyphicon glyphicon-remove"></span>Not found</div>
